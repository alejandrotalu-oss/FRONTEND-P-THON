// La siguiente línea imprime en la consola del navegador el texto ¡Hola Javascript!
...
console.log(typeof "Alejandro") //string
...
// 2.4. underfined, no tiene valor aún
...
console.log(pi)
// pi = 4.98888  // x <-- Uncaught TypeError: Assignment to constant variable.
 ...
 // Ejercicio: Dadas dos variables, a con valor 10 y b con valor 3. Realiza una operación que permita obtener el residuo de la división entre a y b. Luego muestra el resultado en console
...
// 1. Definir las variables para hallar el área de un triangulo. Base = 10, Altura = 5. Imprimir el resultado en la consola  
...
console.log("Hola"+ nombre2) //HolaAlejandro
console.log("Hola "+ nombre2)
console.log("Hola "+ nombre2 + ", tienes " + edad2 + " años.") //Hola Alejandro, tienes 39 años.
//Mejor forma de concatenar (template strings) - backtick (altgr + })
...
// - Nuestre "fizzbuzz" si el número es divisible entre 3 y 5.
// - Muestre "fizz" si el número es divisible solo entre 3.
// - Muestre "buzz" si el número es divisible solo entre 5.
// - En cualquier otro caso, debe mostrar al mismo número.
...
console.log(miNombre[0]) //A
console.log(miNombre[2]) //l
console.log(miNombre[3]) //e

//Métodos importantes de las cadenas de texto

console.log(miNombre.toLowerCase()) // alejandro
console.log(miNombre.toLocaleUpperCase()) // ALEJANDRO
console.log(miNombre.includes()) // true

// EJERCICIOS

// 1. Dado un string, crear una funcion llamada evaluarTexto que devuelvan: "Largo" si tiene más de 10 caracteres y "Corto" si tiene 10 o menos.
// 2. Dado un string, crear una funcion llamada invertirTexto que devuelvan el texto invertido. Ej. hola ->aloh 
